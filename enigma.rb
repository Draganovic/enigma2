...
# Characters 0-9
 ...
 # A:
 #  offset: 0
 #  rotation: 58 (first two digets of the key)
 #
 #  B:
 #   offset: 2
 #   rotation: 83 (first two digets of the key)
 #
 #   C:
 #    offset: 2
 #    rotation: 36 (first two digets of the key)
 #
 #    D:
 #     offset: 5
 #     rotation: 67 (first two digets of the key)
 #
 #
